...
### delete - B+ tree Collection 삭제

기존 [key-value item의 s삭제 명령](./Chapter-2.-Simple-Key-Value-Command.md#2-3-deletion)을 그대로 사용한다. 
...
- \<eflag_update\> - eflag update 명시.
                     [Collection 기본 개념]./Chapter 1. ARCUS Basic Concept.md#1-2. collection concept)에서 eflag update를 참조 바란다.
